...
const heroComponent = _base.homepage.heroComponentContent.filter((el) => {
  if (
    ...
    (getThemeFromUrl() || BRAND_NAME) === 'birmingham-midshires'
  ) {
    el.imageSrc = birminghamMidshiresLogo;
    el.subHeading =
      'A software development kit (SDK) for building web apps tailored to Birmingham Midshires';
  }
  return el;
});
